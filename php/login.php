<?php
	...
	if(isset($_COOKIE[$CookieName])){
		...
		$query = "Select * From TodoUsers Where Email = '$Email' and CookieContent = '$CookieContent';";
	...
	$query = "Select * From TodoUsers Where Email = '$Email' and Password = '$Password';";
	$result = mysqli_query($con,$query);
	if(!result){
		$_SESSION["RegState"]= 0;
	...
	$_SESSION["RegState"] = 6; //Logged in
	$_SESSION["Message"] = "Login success.";
	$_SESSION["user_id"] = $row["ID"];

	$query = "Update TodoUsers Set CookieContent = '$SessionId', LDatetime = '$Ldatetime' Where Email = '$Email';";
	$result = mysqli_query($con,$query);
	if(!result){
		$_SESSION["RegState"]= 0;
